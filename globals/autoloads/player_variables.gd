...
func _ready():
	...
	add_child(inventory.back())
	inventory.append(Seeds.new(preload("res://entities/tools/seeds/corn_seed.tres") as Seed_Data))
	add_child(inventory.back())
	inventory.append(Seeds.new(preload("res://entities/tools/seeds/tomato_seed.tres") as Seed_Data))
	add_child(inventory.back())
	inventory.append(Seeds.new(preload("res://entities/tools/seeds/eggplant_seed.tres") as Seed_Data))
	add_child(inventory.back())
